...
1) Copy U2W.SH (Uninstall Script) and ui.tar.gz.original (Original Stock Theme) - To root of an empty USB stick formatted in FAT32
                                 -> ui.tar.gz.original was copied to USB during installation.
...
4) When the installation is FINISHED the RED light will turn back on.
